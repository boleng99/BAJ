...
for brayen in range(10000):
    ...
    u2 = f"Dalvik/2.1.0 (iPhone; CPU iPhone OS {str(rr(11,16))}_{str(rr(4,9))}_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 Version/{str(rr(4,19))}.{str(rr(1,9))} Safari/605.1.15"
